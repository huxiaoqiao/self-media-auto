...
import { t as safeEqualSecret } from "./secret-equal-Dviv9Wgm.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-H_waaYcL.js";
import { t as createDedupeCache } from "./dedupe-DM7iBj7C.js";
import { a as resolveSessionStoreEntry } from "./store-BR_PFx8O.js";
import { t as loadSessionStore } from "./store-load-Dlqr4N0q.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-Sf3qwjba.js";
import { h as sendMediaWithLeadingCaption, m as resolveTextChunksWithFallback, p as resolveSendableOutboundReplyParts } from "./reply-payload-DIW-0l1V.js";
import { n as deriveLastRoutePolicy } from "./resolve-route-BnICj2wG.js";
import { r as getSessionBindingService } from "./session-binding-service-D6sb-LrK.js";
import "./text-runtime-CBbdVKsK.js";
import "./routing-m3jFzBzX.js";
import "./error-runtime-BbMhGHsP.js";
import { n as isAbortRequestText } from "./abort-primitives-BslXMh9Y.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-Yg0zPcHf.js";
import { a as buildPendingHistoryContextFromMap, s as clearHistoryEntriesIfEnabled, u as recordPendingHistoryEntryIfEnabled } from "./history-Dy2s6tq6.js";
import "./reply-history-fX9upQ6A.js";
import { r as logTypingFailure } from "./logging-Bx-iPPpy.js";
import { t as createReplyPrefixContext } from "./reply-prefix-BCq-aIeK.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-DWs0WuLS.js";
import { n as createChannelPairingController } from "./channel-pairing-DtH8N34u.js";
import { a as createFixedWindowRateLimiter, o as createWebhookAnomalyTracker, r as WEBHOOK_RATE_LIMIT_DEFAULTS, t as WEBHOOK_ANOMALY_COUNTER_DEFAULTS } from "./webhook-memory-guards-a5Ny_9tk.js";
import { i as installRequestBodyLimitGuard } from "./http-body-D3h9UVlm.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-1XnL5G6D.js";
import "./webhook-ingress-DuG32bKY.js";
import { n as filterSupplementalContextItems, t as evaluateSupplementalContextVisibility } from "./context-visibility-Zd-kGSzB.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-Ccg_uZyq.js";
import { n as isBtwRequestText } from "./btw-command-mkRCaY2H.js";
import "./reply-runtime-Bil2dVoM.js";
import { t as buildAgentMediaPayload } from "./agent-media-payload-BUE-DXcC.js";
import { n as resolveAgentOutboundIdentity } from "./identity-Cdy0UEyN.js";
import "./outbound-runtime-D7BxPBZc.js";
import "./ssrf-runtime-BvpyAURv.js";
import { n as resolveConfiguredBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-ClFjxSCF.js";
import "./conversation-runtime-BxdVgsIS.js";
import "./browser-security-runtime-DC9Kwbd7.js";
import "./channel-feedback-B0PhMXNS.js";
import { n as createPersistentDedupe } from "./persistent-dedupe-BveScXX-.js";
import { a as isRecord, c as readString, l as buildFeishuCommentTarget, n as encodeQuery, o as normalizeString, r as extractReplyText, s as parseCommentContentElements, u as normalizeCommentFileType } from "./comment-shared-BnV7Qvhn.js";
import { a as createFeishuClient, f as resolveFeishuAccount, i as createEventDispatcher, l as listEnabledFeishuAccounts, n as raceWithTimeoutAndAbort, o as createFeishuWSClient, p as resolveFeishuRuntimeAccount, r as waitForAbortableDelay, s as getFeishuUserAgent, t as probeFeishu } from "./probe-1bmu5MTy.js";
import { h as resolveReceiveIdType, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-DFepQFdN.js";
import { a as resolveFeishuReplyPolicy, c as createFeishuCardInteractionEnvelope, l as decodeFeishuCardAction, n as resolveFeishuAllowlistMatch, r as resolveFeishuGroupConfig, s as buildFeishuCardActionTextFallback, t as isFeishuGroupAllowed } from "./policy-DwQQRkW2.js";
import { t as buildFeishuConversationId } from "./conversation-id-CNqa_GYP.js";
import { t as getFeishuRuntime } from "./runtime-Bzn6HCjL.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-OHEiRkyF.js";
import "./runtime-api-Brrol_K5.js";
import { a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isMentionForwardRequest, h as normalizeFeishuExternalKey, i as resolveFeishuCardTemplate, l as parsePostContent, m as sendMediaFeishu, n as getMessageFeishu, p as downloadMessageResourceFeishu, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-CphP-EM_.js";
...
function registerEventHandlers(eventDispatcher, context) {
	...
	eventDispatcher.register({
		...
		"card.action.trigger": async (data) => {
			try {
				// ---- Card Server forwarding: intercept custom card actions ----
				// Extract action value from raw data before parsing
				// Fix: also check nested structure data.event.action.value (Feishu native format)
				const rawActionValue = data?.action?.value ?? data?.event?.action?.value;
				const actionValueStr = typeof rawActionValue === 'string' ? rawActionValue : 
					                       (typeof rawActionValue === 'object' && rawActionValue !== null ? JSON.stringify(rawActionValue) : '');
				if (actionValueStr) {
					const actionPart = actionValueStr.split('_')[0].replace(/^["']|["']$/g, '');
					const cardServerActions = ['rewrite', 'approve', 'modify', 'rescript', 'rearticle', 'post', 'copy', 'cancel', 'insight', 'next', 'init'];
					if (cardServerActions.includes(actionPart)) {
						// Fix: transform nested Feishu event structure to flat structure before forwarding
						...
						// Forward to card server and return early
						...
						try {
							...
							if (response.ok) {
								return; // Don't process further in OpenClaw
							}
						} catch (err) {
				...
				// Fix: handle flat Feishu card action structure completely
				// parseFeishuCardActionEventPayload requires:
				//   - operator.open_id, operator.user_id, operator.union_id
				//   - action.tag, action.value (Record)
				//   - context.open_id, context.user_id, context.chat_id
				// But Feishu sends: context.open_message_id, context.open_chat_id (different field names!)
				// And action.value is a STRING, not an object
				// So we transform everything to match what the parser expects
				if (data.action && !data.action._fixed) {
					// Wrap string action.value into object structure
					if (typeof data.action.value === 'string') {
						const originalTag = data.action.tag || '';
						const originalValue = data.action.value || '';
						data.action.value = {
							button: {
								tag: originalTag,
								value: originalValue
					...
					// Fix context field names: open_message_id -> open_id, open_chat_id -> chat_id
					// Also add user_id if missing
					if (data.context) {
						if (!data.context.open_id && data.context.open_message_id) {
							data.context.open_id = data.context.open_message_id;
						}
						if (!data.context.chat_id && data.context.open_chat_id) {
							data.context.chat_id = data.context.open_chat_id;
						}
						if (!data.context.user_id && data.operator && data.operator.user_id) {
							data.context.user_id = data.operator.user_id;
						}
					}
					data.action._fixed = true;
				}
				
				// DEBUG: log data structure before parsing
				console.log('[DEBUG] data structure:', JSON.stringify({
					has_event: !!data.event,
					has_action: !!data.action,
					action_keys: data.action ? Object.keys(data.action) : [],
					has_operator: !!data.operator,
					operator_keys: data.operator ? Object.keys(data.operator) : [],
					has_context: !!data.context,
					context_keys: data.context ? Object.keys(data.context) : [],
					token: data.token,
					action_tag: data.action?.tag,
					action_value_type: typeof data.action?.value,
				}));
